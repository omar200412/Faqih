...
const styles = StyleSheet.create({
  ...
  closeBtn:       { padding: 8 },
  closeBtnText:   { fontSize: 16, color: colors.textMuted, fontFamily: fonts.semibold },
  qCounter:       { fontSize: 14, fontFamily: fonts.semibold, color: colors.textMuted },
  ...
  questionText:  { fontSize: 20, fontFamily: fonts.heading, color: colors.text, lineHeight: 30 },
  ...
  matchHint:     { fontSize: 12, color: colors.textMuted, fontFamily: fonts.semibold, marginBottom: 10, textAlign: 'center' },
  matchWrap:     { gap: 10 },
  ...
  matchChipText:     { fontSize: 13, fontFamily: fonts.semibold, color: colors.text, textAlign: 'center' },
  ...
  videoPlayIcon: { fontSize: 22, color: colors.white, fontFamily: fonts.headingXB },
  videoDoneBtn: {
    backgroundColor: colors.card, borderRadius: radius.full, borderWidth: 1.5, borderColor: colors.primary,
    paddingVertical: 14, alignItems: 'center',
  },
  videoDoneText: { fontSize: 15, fontFamily: fonts.semibold, color: colors.primary },
  ...
  feedbackTitle:    { fontSize: 18, fontFamily: fonts.headingXB, marginBottom: 8 },
  ...
  introTitle: { fontSize: 22, fontFamily: fonts.headingXB, color: colors.primary },
  ...
  resultTitle:      { fontSize: 30, fontFamily: fonts.headingXB, color: colors.primary, marginBottom: 4 },
  ...
  resultStatValue:  { fontSize: 22, fontFamily: fonts.headingXB, color: colors.text, marginBottom: 4 },
  resultStatLabel:  { fontSize: 11, color: colors.textMuted, fontFamily: fonts.semibold, textTransform: 'uppercase' },
  resultActions:    { width: '100%', gap: 10 },
  homeBtn:          { backgroundColor: colors.card, borderRadius: radius.full, borderWidth: 1.5, borderColor: colors.primary, paddingVertical: 14, alignItems: 'center' },

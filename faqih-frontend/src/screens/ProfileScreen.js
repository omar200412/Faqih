...
const styles = StyleSheet.create({
  ...
  avatarLetter: { fontSize: 36, fontFamily: fonts.headingXB, color: colors.white },
  heroName:     { fontSize: 24, fontFamily: fonts.heading, color: colors.white, marginBottom: 8 },
  ...
  levelText:    { fontSize: 13, color: colors.white, fontFamily: fonts.semibold, letterSpacing: 0.5 },
  xpSection:    { width: '100%' },
  xpLabels:     { justifyContent: 'space-between', marginBottom: 6 },
  xpLabel:      { fontSize: 11, color: 'rgba(255,255,255,0.7)', fontFamily: fonts.semibold },
  xpBar:        { height: 10 },
  statsRow:     { flexDirection: 'row', gap: 10, paddingHorizontal: spacing.md, marginTop: spacing.lg },
  section:      { marginTop: spacing.lg, paddingHorizontal: spacing.md },
  sectionTitle: { fontSize: 16, fontFamily: fonts.headingXB, color: colors.text, marginBottom: 12, letterSpacing: 0.2 },
  ...
  dayCheck:     { color: colors.white, fontSize: 14, fontFamily: fonts.semibold },
  dayLabel:     { fontSize: 11, color: colors.textMuted, fontFamily: fonts.semibold },
  ...
  summaryValue: { fontSize: 22, fontFamily: fonts.headingXB, color: colors.primary, marginBottom: 2 },
  summaryLabel: { fontSize: 11, color: colors.textMuted, fontFamily: fonts.semibold, textAlign: 'center' },
  achGrid:      { flexDirection: 'row', flexWrap: 'wrap', gap: 10 },
  achCard:      { width: '47.5%', backgroundColor: colors.card, borderRadius: radius.lg, alignItems: 'center', padding: 14, ...shadow.sm },
  achLocked:    { backgroundColor: colors.cardAlt, opacity: 0.7 },
  achIcon:      { fontSize: 30, marginBottom: 6 },
  achIconLocked: { opacity: 0.4 },
  achTitle:     { fontSize: 13, fontFamily: fonts.headingXB, color: colors.text, textAlign: 'center', marginBottom: 4 },
  ...
  achBadgeText: { fontSize: 10, color: colors.correct, fontFamily: fonts.semibold },
